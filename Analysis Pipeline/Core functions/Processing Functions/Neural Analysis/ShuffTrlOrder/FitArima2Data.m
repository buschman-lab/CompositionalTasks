function SaveFileName=FitArima2Data(Lag,Metric,AvgDim2,FileNameSpecs,Observed_Org,Shuffle_Org,Dim)
...
PATH=[AnalysisOpts.DataSavePath 'Code Test Data' filesep];
