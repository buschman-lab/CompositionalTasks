...
PATH=[AnalysisOpts.DataSavePath 'GLM' filesep 'ALL' filesep];

PreTxt='AllAnglesStructLambda_';
[row,col] = ind2sub([4 3],1:12);
Lam=4;
for Mdl=Models
    ModelPATH=[PATH 'GLM_ALL_ALL_75_cl2' Mdl{1} '_AngleStats.mat'];
...
fp.SaveCurrentFigs(['GLM_AngleAnalysisCompareAllMdls' ],[AnalysisOpts.ResultsSavePath 'Low Dim Analysis' filesep],'SaveEachFrame',1)
