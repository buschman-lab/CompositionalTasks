...
if AnalysisOpts.ProcessingStep==4 % if we are plotting classifiers then preload them
    ...
    if (~strcmp(AnalysisOpts.Classifier_TrlShuff_TrendCorrMethod,'Modified_MannKendall') | ...
            ...
            ~AnalysisOpts.SkipLoadingShuffleFile & ~contains(AnalysisOpts.PopulationAna.Classifier_TaskNameSet{AnalysisOpts.PairNum},'Learning3D_AxisDecoding')
...
NeuralAnalysisOpts={'ZscoreFlag',0,'ZscoreFlag',0,'GLMLambda',0,'SaveStatTestFigs',0,...
