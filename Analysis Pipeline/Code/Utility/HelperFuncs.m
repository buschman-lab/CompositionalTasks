...
classdef HelperFuncs
    ...
    methods
        ...
        function [TimeFreq,FigPrms,ManData,TrialFunc,FilterFunc,NeuAnaFunc,CrosFreqCop,AnalysisFunc]=LoadAnalysisClasses(~)% loads all of the classes we have so far
            global AnalysisOpts 
            ...
            AnalysisFunc=AnalysisFuncs; % Main functions fro analysis 
        end
