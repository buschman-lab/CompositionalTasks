...
function SuppFigures(DataPath,FigSavePath)
...
%% Figure S8cde 
FigSaveFileName='FigS8cde';

% generate figure
varargout=cell(3);
[varargout{1}]=PlotCorrelationAnalysis('FigS8c',DataPath);
[varargout{2}]=PlotCorrelationAnalysis('FigS8d',DataPath);
[varargout{2}]=PlotCorrelationAnalysis('FigS8e',DataPath);
%  save the figures we have generated
FigParams.SaveFigSeries(FigSaveFileName, FigSavePath,varargout,'SaveEachFrame',1,'enforce_daspect',1)

%% Figure S8h 
FigSaveFileName='FigS8hi';

% generate figure
varargout=cell(2);
[varargout{1}]=PlotCorrelationAnalysis('FigS8h',DataPath);
[varargout{2}]=PlotCorrelationAnalysis('FigS8i',DataPath);
