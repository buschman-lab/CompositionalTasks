 function GenerateRecAnalysisFile(RunonCluster,DateNum,ChNum,AreaNum,PairNum,varargin)
% Generates analysis file for each recording 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
NChsSet=size(nchoosek(ChsSet,2),1);
WriteBashScript(AnalysisOpts.RecDate,'Motif_CoherenceAnalysis',{1,DateNum,'[]',6,'$SLURM_ARRAY_TASK_ID','ReRefChannels',0},{'%i','%i','%s','%i','%s',"'%s'",'%i'},...
    sprintf('%i-%i',1,NChsSet),50,200);
 end
