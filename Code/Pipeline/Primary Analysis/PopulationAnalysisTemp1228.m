function [TrialTimes,RuleBlockTrials,ChannelInfo,ChannelArea,ChsSet]=PopulationAnalysisTemp(RunonCluster,DateNum,ChNum,AreaNum,PairNum,varargin)
...
ThisTestManual='3D_Shape_Cat_Xgen';%'';%'Learning3D_Shape_Color_Rule_Xgen_AltRuleR1_RB';%'3D_Shared_Color_Response_EntropyR3';%'3D_Shared_Color_Response_EntropyR3';%Learning3D_Shape_Color_Rule_Xgen_AltRuleR1_RB';%;'3D_Color_Response_XgenR2R3Entropy';%'';%'Learning3D_Shape_Color_Rule_Xgen_AltRule_RB';%'Learning3D_Color_Response_Rule_Xgen_AltRule';%'Learning3D_Shape_Color_Rule_Xgen_AltRule_RB';%'3D_Color_Response_XgenBalInCongV2Test';%'3D_Color_Cat_Xgen';%'3D_Color_Response_XgenBalInCongV2Test';%'Learning3D_Shape_Color_Rule_Xgen_AltRule_RB';%'3D_Color_Response_XgenBalInCongV2';%'Learning3D_Shape_Color_Rule_Xgen_AltRule_RB';%'Learning3D_Color_ShapeCorrInCorr_Rule_Xgen_AltRule';%'3D_Shared_Color_Response_Entropy';%'Learning3D_Color_Shape_Rule_Xgen_AltRule';%'3D_Color_Response_XgenBalInCong';%'Learning3D_Color_Color_Rule_Xgen_AltRuleR1';%'3D_ColorCategoryFineTuneSig';%'ResponseLocation_BalCorr';%'3D_ColorCategoryFineTuneSig';%'3D_Color_Response_Xgen';%'3D_Shape_Cat_Xgen_BalRespDir';%'Learning3D_Color_Shape_Rule_Xgen_AltRule';%'3D_Color_Cat_Xgen';%;%'Learning3D_Color_Shape_Rule_Xgen_AltRule';%'3D_FineTuneColorCategoryClassifier';%'3D_Color_Response_XgenR2R3Entropy';
...
elseif AnalysisOpts.ProcessingStep==3 & ...
      strcmp(AnalysisOpts.PopulationAna.Classifier_TaskNameSet{AnalysisOpts.PairNum},'BalInCongV')
  ClassifierResults=[];ClassifierOpts=[];ClassifierResults_Shuff=[];ClassifierResults_Observed=[];ClassifierOpts_Shuff=[];
    AnalysisOpts.UseRep4Cluster=1; % use repetition for cluster runs only for shuffle      
...
NeuralAnalysisOpts={'ZscoreFlag',0,'ZscoreFlag',0,'GLMLambda',0,...
    ...
    'ClassifierResults_Loaded',ClassifierResults,'ClassifierOpts_Loaded',ClassifierOpts,'ClassifierOptsShuff_Loaded',ClassifierOpts_Shuff,....
