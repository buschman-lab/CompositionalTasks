...
if obj.CalShuffTrlOrder % if we are shuffleing the trial order then we will need to do it within the target factor and all of the balances we are doing
    ...
    [ShuffLbl,TrialIndex,TrainCondIndex,BlkOrderShuff,RevTrlNumShuff,EngagedTrails]=SamplefromFactor(ManData,ClassifierOpts,'TrialNum',TargetFields,FactorData,DimNum,IndTestCond,SeqHistVal,Cond,TrlTypeVal_Test,TrialRngInc,ShuffleTrlSet);
else
    ...
    [ShuffLbl,TrialIndex,TrainCondIndex,BlkOrderShuff,RevTrlNumShuff,EngagedTrails]=SamplefromFactor(ManData,ClassifierOpts,TargetFactor,TargetFields,FactorData,DimNum,IndTrainCond,SeqHistVal,Cond,TrlTypeVal_Train,TrialRngInc,ShuffleTrlSet);
end
...
function [ShuffLbl,TrialIndex,TrainCondIndex,BlkOrderShuff,RevTrlNumShuff,EngagedTrails]=SamplefromFactor(ManData,ClassifierOpts,TargetFactor,TargetFields,FactorData,DimNum,IndTrainCond,SeqHistVal,Cond,TrlTypeVal,TrialRngInc,ShuffleTrlSet)
